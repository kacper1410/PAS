...
//            throw new TestAbortedException();
//        }
//        Assert.assertThrows(NotValidException.class,() -> resourceManager.updateBook(audioBook, 123, "New", "New", 111));
//
//
//        try {
...
//            throw new TestAbortedException();
//        }
//        Assert.assertThrows(NotValidException.class,() -> resourceManager.updateAudioBook(book, 123, "New", "New", 111));
//
//        try {
