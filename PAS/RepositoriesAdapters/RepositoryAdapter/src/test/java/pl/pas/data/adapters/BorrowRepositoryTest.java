...
public class BorrowRepositoryTest {
    ...
    public void testAddBorrow() {
        ...
        try {
            Assertions.assertEquals(borrowRepository.getBorrow(borrow1.getBorrowId()), borrow1);
            Assertions.assertEquals(borrowRepository.getBorrow(borrow2.getBorrowId()), borrow2);
